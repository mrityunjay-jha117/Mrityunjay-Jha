...
export default function ThreeDMarqueeDemo() {
  ...
  return (
    <div
      id="skills-section"
      className="relative w-full mx-auto mb-6 sm:mb-10 overflow-hidden flex flex-col items-center justify-center py-4 sm:py-6 lg:py-8" // Reduced padding
      style={{ willChange: "auto" }} // Remove unnecessary willChange
    >
      <div className="text-blue-500 font-black text-3xl lg:text-7xl xl:text-8xl 2xl:text-9xl mb-3 sm:mb-4 lg:mb-6 z-0 text-center">
        {" "}
        {/* Reduced margins */}
        SKILLS
      </div>
      ...
      >
        <ThreeDMarquee
          columns={columns}
          images={images}
          speed={0.7} // Slightly faster for smoother feel
        />
      </div>
    </div>
  );
