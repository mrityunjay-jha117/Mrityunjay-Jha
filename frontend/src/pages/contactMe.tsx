export default function Sixth() {
  return (
    <div
      id="contact-section"
      className="min-h-screen mx-4 sm:mx-8 md:mx-16 lg:mx-24 xl:mx-36 mb-6 sm:mb-10 rounded-2xl sm:rounded-3xl lg:rounded-4xl overflow-hidden bg-gradient-to-b from-gray-900 to-black text-white"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <a
                ...
                className="text-sm sm:text-base text-gray-300 hover:text-red-400 transition-colors break-all"
              >
            ...
            <div className="flex space-x-3 sm:space-x-4 pt-2 sm:pt-4">
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-red-500 transition-colors"
              >
                <svg
              ...
              <a
                href="https://linkedin.com/in/mrityunjay-jha-117"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-red-500 transition-colors"
              >
        ...
        <div className="w-full lg:w-1/2 mt-8 lg:mt-0">PROJECT 3</div>
      </div>
    </div>
  );
}
